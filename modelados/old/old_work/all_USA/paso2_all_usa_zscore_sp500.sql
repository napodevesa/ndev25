CREATE TABLE modelados.all_usa_zscore_sp500 AS
SELECT
    r.ticker,
...
FROM procesados.multifactor_all_usa_ratios_keymetrics r
LEFT JOIN modelados.all_usa_benchmark_sector_industry_mktcap b
