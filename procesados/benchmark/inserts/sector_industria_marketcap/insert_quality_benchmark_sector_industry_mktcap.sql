-- ============================================================
-- INSERT: procesados.quality_benchmark_sector_industry_mktcap
-- Benchmark Quality por Sector + Industry + Market Cap Tier
-- Fecha hardcodeada: modificar según el mes
-- ============================================================
 
INSERT INTO procesados.quality_benchmark_sector_industry_mktcap (
    snapshot_date,
    sector,
    industry,
    market_cap_tier,
...
FROM procesados.quality_benchmark_sector_industry_mktcap
