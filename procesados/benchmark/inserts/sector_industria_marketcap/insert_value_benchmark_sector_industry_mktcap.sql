-- ============================================================
-- INSERT: procesados.value_benchmark_sector_industry_mktcap
-- Benchmark Value por Sector + Industry + Market Cap Tier
-- Fecha hardcodeada: modificar según el mes
-- ============================================================
 
INSERT INTO procesados.value_benchmark_sector_industry_mktcap (
    snapshot_date,
    sector,
    industry,
    market_cap_tier,
...
FROM procesados.value_benchmark_sector_industry_mktcap
