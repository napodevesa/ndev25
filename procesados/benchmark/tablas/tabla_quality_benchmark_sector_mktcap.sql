...
-- Benchmark de Quality por Sector + Market Cap Tier
-- 4 métricas: roic, netdebt_ebitda, operating_margin, debt_equity
-- ============================================================

--DROP TABLE IF EXISTS procesados.quality_benchmark_sector_mktcap;

CREATE TABLE procesados.quality_benchmark_sector_mktcap (
